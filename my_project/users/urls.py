...
from .views import register, login, get_profile, update_profile, contact, change_password, get_packages, packages_title, get_package_by_id, add_to_wishlist, get_wishlist, book_package,get_bookings,remove_from_wishlist,submit_review
